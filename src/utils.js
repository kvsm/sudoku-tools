...
export const regionIndexes = [...rowIndexes, ...columnIndexes, ...blockIndexes]

const getRegions = R.curry((indexes, state) => {
  return R.map(r => R.map(i => state[i], r), indexes)
})
export const getRegionsFromState = getRegions(regionIndexes)
